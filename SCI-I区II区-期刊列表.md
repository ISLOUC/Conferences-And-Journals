...
||ADVANCES IN COMPUTATIONAL MATHEMATICS|1.439|应用数学|容易|>12周|或约稿|
...
||APPLIED MATHEMATICS AND OPTIMIZATION|1.175|应用数学|容易|>12周|或约稿|
||APPLIED NUMERICAL MATHEMATICS|1.263|应用数学|容易|约7.5个月|
||Communications in Applied Mathematics and Computational Science|2.125|应用数学|较易|>12周|或约稿|
...
||STUDIES IN APPLIED MATHEMATICS|1.829|应用数学|容易|>12周|或约稿|
||Bulletin of Mathematical Sciences|1.333|数学|-|-|
||BULLETIN OF THE AMERICAN MATHEMATICAL SOCIETY|0.771|数学|较易|>12周|或约稿|
||BIT NUMERICAL MATHEMATICS|1.425|计算机：软件工程|容易|>12周|或约稿|
||STATISTICS AND COMPUTING|1.851|计算机：理论方法|较易|"较慢|6-12周"|
||COMPUTATIONAL STATISTICS & DATA ANALYSIS|1.181|计算机：跨学科应用|容易|"较快|2-4周"|
||MATHEMATICS AND COMPUTERS IN SIMULATION|1.476|计算机：跨学科应用|容易|约18.0个月|
||Enterprise Information Systems|1.683|计算机：信息系统|较难|约稿?周期不定|
