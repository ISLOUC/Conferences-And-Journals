...
|#|期刊|IF|类别|录用率|审稿周期|
|||||||
||Applied and Computational Mathematics|2.365|应用数学|约50%|平均6月|
||APPLIED MATHEMATICS AND COMPUTATION|2.3|应用数学|60%|约9.8个月|
||APPLIED MATHEMATICS AND MECHANICS-ENGLISH EDITION|1.538|应用数学|容易|约2.0个月|
||APPLIED MATHEMATICS AND OPTIMIZATION|1.175|应用数学|容易||
||APPLIED NUMERICAL MATHEMATICS|1.263|应用数学|容易|约7.5个月|
||Communications in Applied Mathematics and Computational Science|2.125|应用数学|较易||
||Communications in Mathematical Sciences|1.451|应用数学|较易|约6.0个月|
||JOURNAL OF COMPUTATIONAL AND APPLIED MATHEMATICS|1.632|应用数学|约75%|约3.0个月|
||JOURNAL OF SCIENTIFIC COMPUTING|1.814|应用数学|较易|"偏慢|4-8周"|
||SIAM JOURNAL ON APPLIED MATHEMATICS|1.698|应用数学|约25%|平均12月|
...
||IEEE Transactions on Dependable and Secure Computing|4.41|计算机：硬件|容易||
...
|2T-1|IEEE TRANSACTIONS ON MULTIMEDIA|3.977|计算机：信息系统|较易|12×25|
||IEEE Transactions on Services Computing|4.418|计算机：信息系统|较易||
